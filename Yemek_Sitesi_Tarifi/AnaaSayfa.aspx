<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="AnaaSayfa.aspx.cs" Inherits="Yemek_Sitesi_Tarifi.AnaaSayfa" %>
        ...
        <ItemTemplate>
            <table class="auto-style12">
                <tr>
                   ...
                   <a href="YemekDetay.aspx?YemekId=<%#Eval ("YemekId") %>">     <asp:Label ID="Label3" runat="server" CssClass="auto-style13" Text='<%# Eval("YemekAdi") %>'></asp:Label></a>
                        </strong></td>
                </tr>
                <tr>
